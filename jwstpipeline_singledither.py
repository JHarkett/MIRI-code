...
python -W ignore jwstpipeline_singledither.py [directory]
...
Version 4:
	- Implemented temporary fix to give channels 1 and 2 correct pix scale
	  for stage 3a
	- Made changes for compatibility with jwst 1.4.3
	- Fixed bugs causing noise in stage 3 outputs
"""
...
def directory_check(directory1,path):
	...
	if not os.path.exists(spec3_directory + '/d' + d):
		os.makedirs(spec3_directory + '/d' + d)
